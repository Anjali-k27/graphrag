...
# Step 1: Normalize nodes that only have 'name' or 'title' but not 'id' or 'original_text'
NORMALIZE = """
MATCH (n)
WHERE n.id IS NULL
...
# Step 2: Add :Entity label to all nodes
ADD_LABEL = "MATCH (n) SET n:Entity"

# Step 3: Fetch nodes with original_text for embedding
FETCH = "MATCH (n:Entity) WHERE n.original_text IS NOT NULL RETURN n.id AS id, n.original_text AS text"

# Step 4: Store embeddings back onto the node as a property
