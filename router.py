...
# Limit the number of tool-call rounds to prevent infinite loops in case of complex queries
MAX_TOOL_ROUNDS = 5 

# Main router function that orchestrates the tool calls based on user input
